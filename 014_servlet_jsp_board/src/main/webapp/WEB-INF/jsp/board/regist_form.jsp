				...
				<tr>
					<td align="center" valign="top">
						...
						<table width="690" border="0" cellpadding="10" cellspacing="0" style="border: solid 1px #d6d7d6;">
							...
							<tr>
								<td align="left" valign="top">첨부파일</td>
							
								<td><input type="file" name="file1" size="58"><br/><input type="file" name="file2" size="58"></td>
							
							</tr>
							<tr>
								<td colspan="2" align="center">
									<input type="submit" value="저장" />
									<input type="button" value="취소"  onclick="location.href=page=${paramBoard.page}"/>
								</td>
							</tr>
						</table>
						</form>
