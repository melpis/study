			...
			<table width="710" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="center" valign="top">
						<form name="frmEdit" method="post" action="/member/edit.do" onsubmit="return validate(this);">
						<table width="690" border="0" cellpadding="10" cellspacing="0" style="border: solid 1px #d6d7d6;">
							...
							<tr>
								...
								<td align="left">
									<input type="password" id="userPw" name="userPw" value="${memberVO.userPw}" size="70" />
								</td>
							</tr>
							<tr>
								<td align="left">패스워드 확인</td>
								<td align="left">
									<input type="password" id="userPwConfirm" name="userPwConfirm" value="${memberVO.userPw}" size="70" />
								</td>
							</tr>
							<tr>
								<td align="left">성명</td>
