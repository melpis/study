			...
			<table width="710" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="center" valign="top">
						<form name="frmRegist" method="post" action="regist.do" onsubmit="return validate(this);">
						<table width="690" border="0" cellpadding="10" cellspacing="0" style="border: solid 1px #d6d7d6;">
							...
							<tr>
								<td align="left" valign="top">이름</td>
								<td align="left" valign="top">
									<input type="text" id="userName" name="userName" value="" size="30" />
								</td>
							</tr>
